...
namespace Neo.Plugins.SignClient
{
    public class Settings : PluginSettings
    {
        ...
        /// Only support local host at present, so host always is "127.0.0.1" now.
        /// </summary>
        ...
        public Settings(IConfigurationSection section) : base(section)
        {
            ...
            Port = section.GetValue("Port", 10123);
        }
        ...
        public static Settings Default
        {
            get
            {
                const string SectionName = "PluginConfiguration";
                var section = new ConfigurationBuilder()
                    .AddInMemoryCollection(new Dictionary<string, string?>
                    {
                        [SectionName + ":Name"] = "SignClient",
                        [SectionName + ":Port"] = "10123"
                    })
                    .Build()
